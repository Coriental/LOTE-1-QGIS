...
lyr_VAU3_2.set('fieldLabels', {'ALIMENTADOR': 'hidden field', 'N° DE SOSTEN': 'hidden field', 'TIPO DE POSTE': 'hidden field', 'COORDENADA X': 'hidden field', 'COORDENADA Y': 'hidden field', });
lyr_ESTAQUEIL1VILMA_3.set('fieldLabels', {'#': 'header label - always visible', 'Tipo': 'header label - always visible', 'Numero de': 'header label - always visible', 'Creado': 'header label - always visible', 'Alimentado': 'header label - always visible', 'Tramo': 'header label - always visible', 'Cuadrilla': 'header label - always visible', 'Latitud': 'header label - always visible', 'Longitud': 'header label - always visible', });
...
lyr_PDL1_11.set('fieldLabels', {'LOTE': 'inline label - always visible', 'CONTRATISTA': 'inline label - always visible', 'ALIMENTADOR': 'inline label - always visible', 'TIPO COLUMNA': 'inline label - always visible', 'N° DE SOSTEN': 'inline label - always visible', 'N° DE FÁBRICA': 'inline label - always visible', 'NRO ANDE': 'inline label - always visible', 'COORDENADA X': 'inline label - always visible', 'COORDENADA Y': 'inline label - always visible', });
lyr_MT3x185L1_12.set('fieldLabels', {'FECHA': 'inline label - always visible', 'INICIO/FIN': 'inline label - always visible', 'LONGITUD': 'inline label - always visible', 'Aliment.': 'inline label - always visible', 'Ítem': 'inline label - always visible', 'corte': 'inline label - always visible', });
...
lyr_BT3x701x501x25L1_15.set('fieldLabels', {'FECHA': 'no label', 'INICIO-FIN': 'no label', 'LONGITUD': 'no label', 'Alimentado': 'no label', 'Corte': 'no label', 'ítem': 'no label', });
